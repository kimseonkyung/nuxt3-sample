module.exports = {
  ...
  // 사용할 ESLint 확장 구성 목록
  extends: [
    'airbnb-base', // airbnb 에서 사용하는 JavaScript 스타일 가이드
    'eslint:recommended', // ESLint 에서 권장하는 기본 규칙
    'plugin:nuxt/recommended', // Nuxt.js 관련 규칙
    'plugin:vue/vue3-recommended', // Vue.js 관련 규칙
    'plugin:prettier/recommended', // Prettier 와 ESLint 의 충돌을 방지하기 위한 규칙
    'plugin:@typescript-eslint/eslint-recommended', // TypeScript ESLint 규칙
    '@nuxtjs/eslint-config-typescript' // Nuxt.js 프로젝트에서 TypeScript 와 함께 사용되는 ESLint 규칙
  ],
  rules: {
    // 사용자 정의 규칙 설정
    ...
    'vue/html-self-closing': 'off', // 셀프 태그 닫기 경고 무시
    'no-shadow': 0, // 변수명 중복 사용을 허용
    '@typescript-eslint/no-shadow': 'error', // TypeScript 에서 변수명 중복 사용 에러
    ...
    'space-before-function-paren': 'off', // 함수와 괄호 사이의 공백에 대한 경고 무시
    // Prettier 코드 스타일 설정
    'prettier/prettier': [
      'error',
      {
    ...
    'global-require': 0 // require 로 이미지 경로를 지정할 때 발생하는 에러 무시
  }
}
